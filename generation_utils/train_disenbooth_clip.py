    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                # print('img_state', img_states.shape)
                combined_prompt = torch.cat((encoder_hidden_states, img_states), dim=1)
                model_pred = unet(noisy_model_input, timesteps, combined_prompt, 
