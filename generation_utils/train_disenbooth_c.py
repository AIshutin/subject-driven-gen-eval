...
def parse_args(input_args=None):
    ...
    parser.add_argument("--abs", action="store_true", 
                        help="Use absolute value or quadratic in contrasive loss")
    parser.add_argument(
        "--revision",
        type=str,
        default=None,
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            with accelerator.accumulate(unet):
                ...
                if args.abs:
                    loss_aux2 = torch.absolute(loss_aux2)
                else:
                    loss_aux2 = loss_aux2 ** 2
            ...
            logs = {"loss": loss.detach().item(), 
                    ...
                    "weak_loss": loss_aux1.item(),
                    "contrasive_loss": loss_aux2.item()}
