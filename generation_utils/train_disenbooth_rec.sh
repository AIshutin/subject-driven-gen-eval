...
export OUTPUT_DIR="checkpoints/disenbooth-noconcept/${SUBJECT_NAME}/sd2.1"
export WANDB_NAME="disenbooth-noconcept-sd2.1-${SUBJECT_NAME}-${CLASS_NAME}"

accelerate launch generation_utils/train_disenbooth_rec.py \
