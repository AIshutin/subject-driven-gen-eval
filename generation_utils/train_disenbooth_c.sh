...
export CONCEPT_NAME="$1</w>"
export CLASS_NAME=$2
export MODEL_NAME="stabilityai/stable-diffusion-2-1-base"
export INSTANCE_DIR="datasets/dreambooth/${SUBJECT_NAME}"
export CLASS_DIR="../synth-dataset-sd-2-1/${CLASS_NAME}"
export OUTPUT_DIR="checkpoints/disenbooth_c_abs/${SUBJECT_NAME}/sd2.1"
export WANDB_NAME="disenbooth_c_abs-sd2.1-${SUBJECT_NAME}-${CLASS_NAME}"

accelerate launch generation_utils/train_disenbooth_c.py \
